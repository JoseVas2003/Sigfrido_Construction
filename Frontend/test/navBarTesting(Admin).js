...
describe('Navigation Bar Testing (Logged in as Admin)', async function () {
    it('Admin Logged In Attempting to Navigate To Home Page', async function () {
        ...
        try {
            ...
            await driver.sleep(1000)
            await emailInput.sendKeys("NewAdmin@account.com") //Valid Admin Email
            await driver.sleep(3000)
  
            let passwordInput = await driver.findElement(By.id('passwordInput'));
            await passwordInput.click()
            await driver.sleep(1000)
            await passwordInput.sendKeys("Admin12345$") //Valid Admin Password
            await driver.sleep(3000)
    ...
    it('Admin Logged In Attempting to Navigate To Portfolio Page', async function () {
        let driver = await new Builder().forBrowser('chrome').build()
        try {
            await driver.get('http://localhost:3000/')
            await driver.manage().window().maximize()
    ...
    it('Admin Logged In Attempting to Navigate To Meet The Owner Page', async function () {
        let driver = await new Builder().forBrowser('chrome').build()
        try {
            await driver.get('http://localhost:3000/')
            await driver.manage().window().maximize()
    ...
    it('Admin Logged In Attempting to Navigate To Reviews Page', async function () {
        let driver = await new Builder().forBrowser('chrome').build()
        try {
            await driver.get('http://localhost:3000/')
            await driver.manage().window().maximize()
    ...
    it('Admin Logged In Attempting to Navigate To Admin Dashboard Page', async function () {
        let driver = await new Builder().forBrowser('chrome').build()
        try {
            await driver.get('http://localhost:3000/')
            await driver.manage().window().maximize()
          ...
          let endingURL = await driver.getCurrentUrl()
          assert(endingURL.includes("http://localhost:3000/adminDashboard"), 'NavBar Test FAILED, Admin Dashboard Page Not Found')
    ...
    it('Admin Logged In Attempting to Navigate To The Logout Button', async function () {
        let driver = await new Builder().forBrowser('chrome').build()
        try {
            await driver.get('http://localhost:3000/')
            await driver.manage().window().maximize()
